...
import { getArchivingCont } from '@/apis/Secuity'
import { onMounted, ref } from 'vue'

const loading = ref(false)
const contentData = ref()

const getArchivingData = async () => {
  loading.value = true
  const { data } = await getArchivingCont({ month: 2024, opType: 1 })
  ...
  <div class="monthStatementBox">
    ...
    <div class="monthStatementTable">
      <div class="itemDropDown">
        ...
        >
          <el-table-column type="index" label="序号" center width="80" align="center" />
          <el-table-column prop="username" label="姓名" width="120px" align="center" />
          <el-table-column prop="timeOfEntry" label="入职时间" width="150px" align="center" />
          <el-table-column prop="mobile" label="手机号" width="150px" align="center" />
          <el-table-column prop="idNumber" label="身份证号码" width="180px" align="center" />
          <el-table-column
            ...
            align="center"
          />
          <el-table-column prop="bankCardNumber" label="开户行" width="180px" align="center" />
          <el-table-column
          ...
          <el-table-column
            ...
            align="center"
          />
          <el-table-column prop="workingCity" label="工作城市" width="150px" align="center" />
          <el-table-column
          ...
          <el-table-column
            ...
            align="center"
          />
          <el-table-column prop="leaveDate" label="离职时间" width="150px" align="center" />
          <el-table-column
          ...
          <el-table-column
            ...
            align="center"
          />
          <el-table-column prop="socialSecurity" label="社保合计" width="150px" align="center" />
          <el-table-column
          ...
          <el-table-column
            ...
            align="center"
          />
          <el-table-column prop="pensionEnterprise" label="养老企业" width="150px" align="center" />
          <el-table-column
          ...
          <el-table-column
            ...
            align="center"
          />
          <el-table-column prop="oldAgeIndividual" label="养老个人" width="150px" align="center" />
          <el-table-column
